export function ProductCardComponent1() {
  return (
    <div className="w-[400px] rounded-2xl bg-[#f7f7f7] p-5">
      <div className="flex h-[500px] items-center justify-center">
        <div className="flex h-[500px] items-center justify-center">
          <img
            src="https://images.samsung.com/is/image/samsung/p6pim/us/s2602/gallery/us-galaxy-s26-ultra-s948-sm-s948uzvexaa-550994083?$product-details-jpg$"
            alt="Galaxy Z Fold8"
