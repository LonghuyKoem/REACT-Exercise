export function ProductCardComponent2() {
  return (
    <div className="w-[400px] rounded-2xl bg-[#f7f7f7] p-5">
      <div className="flex h-[500px] items-center justify-center">
        <div className="flex h-[500px] items-center justify-center">
          <img
            src="https://images.samsung.com/is/image/samsung/p6pim/us/f2607/gallery/us-galaxy-z-fold8-ultra-f976-600251-sm-f976udgaxaa-thumb-553838538?$200_200_PNG$"
            alt="Galaxy Z Fold8"
