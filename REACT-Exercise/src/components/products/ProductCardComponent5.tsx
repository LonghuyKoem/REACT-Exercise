export function ProductCardComponent5() {
  return (
    <div className="w-[400px] rounded-2xl bg-[#f7f7f7] p-5">
      <div className="flex h-[500px] items-center justify-center">
        <div className="flex h-[500px] items-center justify-center">
          <img
            src="https://images.samsung.com/is/image/samsung/p6pim/us/np960xgl-xg2us/gallery/us-galaxy-book4-ultra-16-inch-np960-np960xgl-xg2us-551296558?$PD_GALLERY_PNG$"
            alt="Galaxy Z Fold8"
