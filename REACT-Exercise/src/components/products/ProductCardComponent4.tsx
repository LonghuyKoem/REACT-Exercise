export function ProductCardComponent4() {
  return (
    <div className="w-[400px] rounded-2xl bg-[#f7f7f7] p-5">
      <div className="flex h-[500px] items-center justify-center">
        <div className="flex h-[500px] items-center justify-center">
          <img
            src="https://images.samsung.com/is/image/samsung/p6pim/us/np750xhd-kb1us/gallery/us-galaxy-book5-15-inch-np750-np750xhd-kb1us-552111615?$PD_GALLERY_PNG$"
            alt="Galaxy Z Fold8"
